...
shinyServer(function(input, output,session) {
  ...
  observe({
    ...
    updateInputsOnTabId(input$ID, input$myGeo, input$myLHJ, input$myMeasure, input$myMultiRace)
  })
...
shinyjs::onclick("map1I",     updateTabsetPanel(session,inputId="ID",selected="interactiveMapTab"))  # 22
shinyjs::onclick("map2I",     updateTabsetPanel(session,inputId="ID",selected="staticMapTab"))  # 23
shinyjs::onclick("rankcauseI",updateTabsetPanel(session,inputId="ID",selected="rankByCauseTab"))  # 33
shinyjs::onclick("ranktableI",updateTabsetPanel(session,inputId="ID",selected="dataTableTab"))  # 45  
shinyjs::onclick("rankgeoI",  updateTabsetPanel(session,inputId="ID",selected="rankByGeographyTab"))  # 44  
shinyjs::onclick("trendI",    updateTabsetPanel(session,inputId="ID",selected="trendTab"))  # 55  
shinyjs::onclick("scatterI",  updateTabsetPanel(session,inputId="ID",selected="socialDeterminantsTab"))  # 66  
...
observeEvent(input$myLHJ, {
  if(input$myLHJ != STATE & input$ID %in% c("interactiveMapTab","staticMapTab")){updateSelectInput(session, "myGeo", selected = "Community") }
})
